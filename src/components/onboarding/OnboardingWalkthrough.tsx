        ...
        <div className="fixed inset-0 overflow-hidden flex flex-col bg-cloud-dancer">
            ...
            <div className="p-8 z-10 bg-white/10 backdrop-blur-md pb-12">
                <div className="flex items-center justify-between max-w-md mx-auto relative">
                    {/* Back Button - Absolute positioned to not affect centering if possible, or just flex managed */}
                    {currentStep > 0 ? (
                        <button
                            onClick={handleBack}
                            className="text-deep-brown/60 hover:text-deep-brown font-bold transition-colors"
                        >
                            Back
                        </button>
                    ...
                    <button
                        onClick={handleNext}
                        className="group flex items-center gap-2 bg-deep-brown text-white px-6 py-3 rounded-full font-bold shadow-lg hover:shadow-xl hover:scale-105 transition-all active:scale-95"
                    >
